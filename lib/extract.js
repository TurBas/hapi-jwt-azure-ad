 ...
 * @param {String} key - name of the key e.g `urlKey`
...
module.exports = function extract (request, options) {
  ...
  if (urlKey && request.query[urlKey]) { // tokens via url
